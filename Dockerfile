...
RUN dnf -y install https://rpms.remirepo.net/enterprise/remi-release-8.rpm && \
    dnf -y --enablerepo=remi install php74 php74-php-mbstring php74-php-process \
                                     php74-php-devel php74-php-igbinary \
                                     php74-php-redis && \
...
RUN echo 'alias make="make -j16"' >> /root/.bashrc && \
    ...
    echo "alias shutdown=\"redis-cli shutdown nosave\"" >> /root/.bashrc && \
